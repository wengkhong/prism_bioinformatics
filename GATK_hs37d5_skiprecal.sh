...
cat /data/share/PRISM_WGS/chromosomes.txt | xargs -n1 -P5 '-I{}' java -jar $GATK -T HaplotypeCaller -R $REFERENCE -D $DBSNP -I $inputbname.sorted.rmdup.bam -ERC GVCF --variant_index_type LINEAR --variant_index_parameter 128000 -o 'haplotypecaller/{}.vcf' -L '{}' -nct 6

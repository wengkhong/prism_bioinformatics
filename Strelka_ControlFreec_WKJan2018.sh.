...
$samtools mpileup -f $REFERENCE $normalinput | pigz -p 32 > $curdir/ControfreeC/"$normalbname$tumorbname"/$normallongbname.pileup.gz
$samtools mpileup -f $REFERENCE $tumorinput | pigz -p 32 > $curdir/ControfreeC/"$normalbname$tumorbname"/$tumorlongbname.pileup.gz
...
SNPfile = /home/jingxian/hg19_snp131.SingleDiNucl.1based.txt2
...
tail -n +2 $tumorlongbname.pileup.gz_CNVs.p.value.txt | $bedtools intersect -loj -a - -b /home/jingxian/refseq.sorted.uniq.nochr.bed > "$normalbname$tumorbname"_CNVs_annotated.txt
